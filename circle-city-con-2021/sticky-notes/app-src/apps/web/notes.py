...
class TcpHandler(StreamRequestHandler):
    ...
    def handle(self):
        try:
            while True:
                # Read first line of HTTP header
                ...
                # Split on whitespace and select the path
                # Ex: GET /flag HTTP/1.0 gives /flag
                route = line.split()[1]
                # Replace [^a-z0-9-/] with . and trim leading & trailing /
                #   IF we can get a leading / we can do LFI
